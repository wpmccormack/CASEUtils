...
class Fitter(object):
    ...
    def qcdShape(self,name = 'model',poi="MVV",nPars=2):
        ...
        if nPars==2:
            ...
            self.w.factory("p5[1000, 1., 5000.]")
            self.w.factory("p6[1600, 0., 2500.]")
            self.w.factory("p7[1000, 1., 5000.]")
            self.w.factory("p8[1600, 0., 2500.]")

            model = ROOT.RooGenericPdf(name, "(-.5*tanh((@0-@8)/@7) + 1.5)*(.5*tanh((@0-@6)/@5) + .5)*pow(1-@0/13000., @1) / ( pow(@0/13000., @2+@3*log(@0/13000.)+@4*pow(log(@0/13000.),2)) )", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4"), self.w.var("p5"), self.w.var("p6"), self.w.var("p7"), self.w.var("p8")))
            ...
            self.w.factory("p4[4.17695e-01, -100., 100.]")
            """
            self.w.factory("p0[7.66573e+00, 0. , 20]")
            self.w.factory("p2[7.66573e+00, 0. , 20]")
            self.w.factory("p3[-5.15441e+00, -10, 0]")	 
            self.w.factory("p4[1.22752e+00, 0., 5.]")
            self.w.factory("p5[-1.72024e-01, -1., 0.]")
            #set-1
            #self.w.factory("p1[3.64825e-05, -1000. , 1000.]")
            #self.w.factory("p2[2.78348e+00, -100, 100]")	 
            #self.w.factory("p3[7.17321e+00, 0., 50.]")
            ...
            self.w.factory("p3[2.35256e+00, -100., 100.]")
            self.w.factory("p4[4.17695e-01, -100., 100.]")
            self.w.factory("p5[3.6, 0, 300]")	 
            self.w.factory("p6[1700, 1400., 2500.]")
            self.w.factory("p7[200, 50., 500.]")
            model = ROOT.RooGenericPdf(name, "pow(1-@0/13000., @1)/ ( pow(@0/13000., @2+@3*log(@0/13000.)+@4*pow(log(@0/13000.),2)) ) - @5*exp(-(@0-@6)/@7)", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4"), self.w.var("p5"), self.w.var("p6"), self.w.var("p7")))
            """
            ...
            self.w.factory("p3[2.35256e+00, -100., 100.]")
            self.w.factory("p4[4.17695e-01, -100., 100.]")
            self.w.factory("p5[5.17695e-01, -100., 100.]")

            model = ROOT.RooGenericPdf(name, "pow(1-@0/13000., @1)/ ( pow(@0/13000., @2+@3*log(@0/13000.)+@4*pow(log(@0/13000.),2)+@5*pow(log(@0/13000.),3)) )", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4"), self.w.var("p5")))
            #alt func
            #model = ROOT.RooGenericPdf(name, "( @1*pow(1-@0/13000 + @4*pow(@0/13000,2),@2) ) / ( pow(@0/13000,@3) )", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4")))
            ...
            self.w.factory("p3[2.35256e+00, -100., 100.]")
            self.w.factory("p4[4.17695e-01, -100., 100.]")
            self.w.factory("p5[2000, 1400., 2500.]")
            self.w.factory("p6[100, 1., 10000.]")
            #set-1
            #self.w.factory("p1[3.64825e-05, -1000. , 1000.]")
            #self.w.factory("p2[2.78348e+00, -100, 100]")	 
            #self.w.factory("p3[7.17321e+00, 0., 50.]")
            ...
            #model = ROOT.RooGenericPdf(name, "exp(-0.5*pow((@0-@5),2.)/@6) * pow(1-@0/13000., @1)/ ( pow(@0/13000., @2+@3*log(@0/13000.)+@4*pow(log(@0/13000.),2)) )", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4"), self.w.var("p5"), self.w.var("p6")))
            model = ROOT.RooGenericPdf(name, "@6+@1*@0/13000+@2*pow(@0/13000,2)+@3*pow(@0/13000,3)+@4*pow(@0/13000,4)+@5*pow(@0/13000,5)", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4"), self.w.var("p5"), self.w.var("p6")))
            #alt func
            #model = ROOT.RooGenericPdf(name, "( @1*pow(1-@0/13000 + @4*pow(@0/13000,2),@2) ) / ( pow(@0/13000,@3) )", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4")))
            ...
            #default set
            """
            self.w.factory("p1[5.28433e+05, 0. , 100000.]")
            self.w.factory("p2[-6.28433e+01, -300. , 300.]")
            self.w.factory("p3[3.03641e-02, -200, 200]")	 
            self.w.factory("p4[-1.35256e-05, -100., 100.]")
            self.w.factory("p5[1.7695e-09, -100., 100.]")
            self.w.factory("p6[-1.51376e-13, -100., 100.]")
            self.w.factory("p7[5.49817e-18, -100, 100.]")
            """
            self.w.factory("p1[46468.3, 0. , 100000.]")
            self.w.factory("p2[-805654, -3000000. , 0.]")
            self.w.factory("p3[5.8309e+06, 0, 10000000.]")	 
            self.w.factory("p4[-2.24482e+07, -10000000., 0.]")
            self.w.factory("p5[4.83497e+07, 0., 100000000.]")
            self.w.factory("p6[-5.51488e+07, -100000000., 0.]")
            self.w.factory("p7[2.60026e+07, 0, 100000000.]")
            #set-1
            #self.w.factory("p1[3.64825e-05, -1000. , 1000.]")
            #self.w.factory("p2[2.78348e+00, -100, 100]")	 
            #self.w.factory("p3[7.17321e+00, 0., 50.]")
            ...
            #model = ROOT.RooGenericPdf(name, "@1+@2*@0+@3*pow(@0,2)+@4*pow(@0,3)+@5*pow(@0,4)+@6*pow(@0,5)+@7*pow(@0,6)", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4"), self.w.var("p5"), self.w.var("p6"), self.w.var("p7")))
            model = ROOT.RooGenericPdf(name, "@1+@2*@0/13000.+@3*pow(@0/13000.,2)+@4*pow(@0/13000.,3)+@5*pow(@0/13000.,4)+@6*pow(@0/13000.,5)+@7*pow(@0/13000.,6)", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4"), self.w.var("p5"), self.w.var("p6"), self.w.var("p7")))
            ...
            self.w.factory("p4[4.17695e-01, -100., 100.]")
            self.w.factory("p5[5.17695e-01, -100., 100.]")
            self.w.factory("p6[4.17695e-01, -100., 100.]")

            model = ROOT.RooGenericPdf(name, "pow(1-@0/13000., @1)/ ( pow(@0/13000., @2+@3*log(@0/13000.)+@4*pow(log(@0/13000.),2)+@5*pow(log(@0/13000.),3)+@6*pow(log(@0/13000.),4)) )", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4"), self.w.var("p5"), self.w.var("p6")))
            #alt func
            #model = ROOT.RooGenericPdf(name, "( @1*pow(1-@0/13000 + @4*pow(@0/13000,2),@2) ) / ( pow(@0/13000,@3) )", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4")))
            """
            #default set
            self.w.factory("p1[1.63054e+01, 0. , 10000.]")
            self.w.factory("p2[-0.59719e+00, -100. , 100.]")
            self.w.factory("p3[-7.31253e-05, -200, 200]")	 
            self.w.factory("p4[6.15301e-08, -100., 100.]")
            self.w.factory("p5[-9.81866e-12, -100., 100.]")
            self.w.factory("p6[5.10452e-16, -100., 100.]")

            model = ROOT.RooGenericPdf(name, "@1+@2*@0/13000+@3*pow(@0/13000,2)+@4*pow(@0/13000,3)+@5*pow(@0/13000,4)+@6*pow(@0/13000,5)", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4"), self.w.var("p5"), self.w.var("p6")))
            #alt func
            #model = ROOT.RooGenericPdf(name, "( @1*pow(1-@0/13000 + @4*pow(@0/13000,2),@2) ) / ( pow(@0/13000,@3) )", ROOT.RooArgList(self.w.var(poi), self.w.var("p1"), self.w.var("p2"), self.w.var("p3"), self.w.var("p4")))
