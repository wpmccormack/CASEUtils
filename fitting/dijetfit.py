...
def dijetfit(options):
    ...
    if(not options.tag == None):
        sig_norm2 = cardWriter(options,histos_sb,qcd_fname,nPars_QCD,sig_file_name,"_FLOAT", False, 0.05952)
    ...
    if(not options.tag == None):
        ...
        #For QUAK fitting, we don't need to continue past this point
        return 0
